...
gramatykę albo przez czytnik banku drzew, więc ``tests/pomiar/test_ruch.py`` sięga
...
``tests/pomiar/test_endings.py`` analizatora nie sięga, choć nazywa
...
KORZEŃ = Path(__file__).resolve().parent.parent.parent
