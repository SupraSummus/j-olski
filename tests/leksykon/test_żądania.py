...
o wiersz werdyktu, który tę odpowiedź niesie, pyta ``tests/werdykt/test_werdykt.py``.

Słownika strona pisząca nie potrzebuje, tak samo jak ``tests/leksykon/test_walenty.py``:
