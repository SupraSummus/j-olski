...
Wydruk werdyktu stoi tu razem z lasem, a nie osobno w ``tests/werdykt/test_werdykt.py``:
...
``tests/werdykt/test_werdykt.py`` pyta o te odpowiedzi, które werdykt dokłada nad rozbiorem,
a ``tests/gramatyka/test_subset.py`` o to, które zdanie olski przyjmuje.
"""
...
@pytest.mark.parametrize(
    ...
    [
        ...
        #  (``WIELOZNACZNE_PRZEZ_NARZĘDNIK`` w ``tests/gramatyka/test_subset.py``).
