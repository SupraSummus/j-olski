...
przepisane do dokumentów pilnuje ``tests/dokumenty/test_wydruki.py``, a co robi warstwa
rozstrzygająca dopisana obok werdyktu — ``tests/rozstrzyganie/test_rozstrzyganie.py``.
