...
Co znaczy przeczytana deklaracja, pilnują ``tests/warstwa-leksykalna/test_projekt.py`` oraz
``tests/warstwa-leksykalna/test_słownictwo.py``: struktura jest tutaj, znaczenie tam.
"""
