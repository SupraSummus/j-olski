...
def _interpunkcja_wypowiedzenia(grammar: Grammar) -> None:
    ...
    # pilnuje tests/gramatyka/test_zdanie_złożone.py, a wywód wraz z zakupem trzyma
    ...
    # i to pilnuje tests/gramatyka/test_zdanie_złożone.py.
    #
    ...
    # Rozłączności trzech symboli za tym znakiem pilnuje tests/gramatyka/test_zdanie_złożone.py,
