...
def _wysunięta_rola(zdanie: Rozwinięcie, symbol: str, czoło: str) -> None:
    ...
    # (docs/konstrukcje-gramatyczne/podrzędność.md#dopełniacz-z-ramy-wysuwa-się-na-czoło-a-celownik-nie).
...
def _zdania_podrzędne(grammar: Grammar) -> None:
    ...
    # (docs/konstrukcje-gramatyczne/podrzędność.md#zdanie-z-że-jest-pozycją-ramy-a-nie-konstrukcją-obok-niej).
    #
    ...
    # (docs/konstrukcje-gramatyczne/podrzędność.md#podrzędność-i-koordynacja-dzielą-przecinek-a-rozdziela-je-produkcja).
    ...
    # docs/konstrukcje-gramatyczne/okolicznik.md#imiesłów-przysłówkowy-stoi-tam-gdzie-okolicznik-wyrażony-zdaniem.
...
def _rodziny_czoła(grammar: Grammar, zdanie: Rozwinięcie) -> None:
    ...
    # docs/konstrukcje-gramatyczne/podrzędność.md#poprzednikiem-zaimka-co-jest-zaimek-albo-zdanie.
    #
    ...
    # trzyma docs/konstrukcje-gramatyczne/podrzędność.md#zaimki-kto-i-co-wchodzą-wszystkimi-pozycjami-naraz.
    grammar.rule(
        GRUPA_PYTAJNA,
