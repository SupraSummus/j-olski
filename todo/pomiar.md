...
Ocenę człowieka najtaniej daje wydruk `--nowe` oddany komuś,
...
Poprawki nieczytane nie są w `próba/usterki.txt` przypadkiem brzegowym,
a ile ich jest, wypisuje `python3 -m harness.usterki`.
