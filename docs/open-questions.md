...
Czytającą była przy tym znów sesja agenta, i próbki to nie osłabia:
sąd sesji z zapisanym powodem jest sądem czytelnika
([corpora.md](corpora.md#baza-sądów-ocenia-znaleziska-a-ocenione-nie-wracają)
trzyma tę decyzję wraz z warunkiem, który ją odwraca).
Wąskością zostaje jeden oceniający, bo drugiej oceny tych samych zdań nie ma.
