...
The condition turns two sentences from ambiguous into rejected,
and one of them is why the count is not a cost:
...
and the live run has an `ign` row — 429 sentences stopped on a form
